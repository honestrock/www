...
<title>Draes - Üye Girişi</title>
<meta name="keywords" content="blue tech, services, free template, web design" />
<meta name="description" content="Blue Tech Services, free website template by templatemo.com" />
...
<div id="templatemo_wrapper">
    ...
    <link rel="stylesheet" href="<?php echo SITE_PUBLIC_DTEMPLATE ; ?>/css/style.css" media="screen" type="text/css" />
		...
		<form action="http://localhost:8088/www/?url=Admin/runLogin" method="POST">
			...
			<fieldset>
				...
				<p><label for="email">Kullanıcı Adı :</label></p>
                                <p><input maxlength="10" size="10" type="text" name="username"></p> 

				<p><label for="password">Şifre :</label></p>
                                <p><input size="10" maxlength="10" type="password" id="password" name="password" value="password" onBlur="if(this.value=='')this.value='password'" onFocus="if(this.value=='password')this.value=''"></p> <!-- JS because of IE support; better: placeholder="password" -->

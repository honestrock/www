...
<title>Draes - Hakkımızda</title>
<meta name="keywords" content="blue tech, news page, free template, web design" />
<meta name="description" content="Blue Tech, News page, free template by templatemo.com" />
<link rel="stylesheet" href="<?php echo SITE_PUBLIC_DTEMPLATE ; ?>/css/css/style.css" media="screen" type="text/css" />
<link href="<?php echo SITE_PUBLIC_DTEMPLATE ; ?>/templatemo_style.css" rel="stylesheet" type="text/css" />
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="services.html" class="services">Üye Girişi</a></li>
                <li><a href="gallery.html" class="gallery">Üye Ol</a></li>
                <li><a href="news.html" class="selected news">Hakkımızda</a></li>
    ...
    <p><br><br> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo SITE_PUBLIC_DTEMPLATE ; ?>/images/hakkimizda.png" align="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <img src="<?php echo SITE_PUBLIC_DTEMPLATE ; ?>/images/Analiz.jpg" align="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='ffffff'font size="+0">Süleyman Demirel Üniversitesi Bilgisayar Mühendisliği Bölümü olarak üniversitemiz içinde bilişim ve bilgisayar teknolojileri alanı üzerine en etkili ve aktif  bölümü olmayı başardık.
<br>
<br>
<p>
